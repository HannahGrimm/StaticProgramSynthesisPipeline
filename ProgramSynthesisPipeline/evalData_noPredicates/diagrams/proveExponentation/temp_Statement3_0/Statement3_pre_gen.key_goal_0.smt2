...
(declare-fun u_z () U)
(declare-fun |u_Helper::pow| (U U U) U)
(declare-fun u_heap () U)
(declare-fun u_b () U)
(declare-fun u_i () U)
(declare-fun u_a () U)
(declare-fun u_n () U)
(declare-fun u_mod (U U) U)
...
(assert (distinct sort_int sort_boolean sort_Heap sort_Null sort_java.lang.Object sort_Field sort_any))
...
(assert (forall ((var_0 U) (var_1 U) (var_2 U)) (! (instanceof (|u_Helper::pow| var_0 var_1 var_2) sort_int) :pattern ((|u_Helper::pow| var_0 var_1 var_2)))))
...
(assert (instanceof u_n sort_int))
(assert (forall ((var_0 U) (var_1 U)) (! (instanceof (u_mod var_0 var_1) sort_int) :pattern ((u_mod var_0 var_1)))))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (and (and (and (= (i2u (* (u2i u_z) (u2i (|u_Helper::pow| u_heap u_b u_i)))) (|u_Helper::pow| u_heap u_a u_n)) (not (= u_i (i2u 0)))) (= (u_mod u_i (i2u 2)) (i2u 1))) (> (u2i u_n) 0)) (> (u2i u_a) 0)) (< (u2i u_n) 6)) (< (u2i u_a) 6)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i u_n))) (k_wellFormed u_heap))))
