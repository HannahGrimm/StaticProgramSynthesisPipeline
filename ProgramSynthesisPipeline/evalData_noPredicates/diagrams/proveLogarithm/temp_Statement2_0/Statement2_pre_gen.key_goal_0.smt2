...
(assert (distinct sort_java.lang.Object sort_any sort_boolean sort_int sort_Null sort_Heap sort_Field))
...
(assert (instanceof u_l sort_int))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (and (and (and (>= (u2i u_N) (* (u2i u_n) (u2i (|u_Helper::pow| u_heap (i2u 2) u_l)))) (< (u2i u_N) (* (+ (u2i u_n) 1) (u2i (|u_Helper::pow| u_heap (i2u 2) u_l))))) (not (= u_n (i2u 1)))) (> (u2i u_N) 0)) (<= (u2i u_n) (u2i u_N))) (>= (u2i u_n) 1)) (>= (u2i u_l) 0)) (< (u2i u_l) (u2i u_N))) (< (u2i u_N) 20)) (k_wellFormed u_heap))))
