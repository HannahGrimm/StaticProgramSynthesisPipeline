...
(assert (distinct sort_any sort_java.lang.Object sort_int sort_Field sort_Null sort_Heap sort_boolean))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (> (u2i u_N) 0) (<= (u2i u_n) (u2i u_N))) (>= (u2i u_n) 1)) (>= (u2i u_l) 0)) (< (u2i u_l) (u2i u_N))) (< (u2i u_N) 20)) (k_wellFormed u_heap))))
