...
(assert (distinct sort_Heap sort_int sort_boolean))
...
; --- Sequent
(assert (not (and (>= (u2i u_N) (* (u2i u_n) (u2i (|u_Helper::pow| u_heap (i2u 2) u_l)))) (< (u2i u_N) (* (+ (u2i u_n) 1) (u2i (|u_Helper::pow| u_heap (i2u 2) u_l)))))))
