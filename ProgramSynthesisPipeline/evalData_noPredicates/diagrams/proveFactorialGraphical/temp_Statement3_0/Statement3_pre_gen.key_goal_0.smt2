...
(assert (distinct sort_int sort_Null sort_java.lang.Object sort_boolean sort_Field sort_any sort_Heap))
...
; --- Sequent
(assert (not (and (and (and (and (>= (u2i u_n) 0) (>= (u2i u_n) 2)) (>= (u2i u_n) 0)) (< (u2i u_n) 6)) (k_wellFormed u_heap))))
