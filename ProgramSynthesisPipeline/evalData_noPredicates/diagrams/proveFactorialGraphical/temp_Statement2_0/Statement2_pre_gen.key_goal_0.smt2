...
(assert (distinct sort_int sort_Null sort_any sort_Heap sort_boolean sort_java.lang.Object sort_Field))
...
; --- Sequent
(assert (not (and (and (and (and (>= (u2i u_n) 0) (= u_n (i2u 1))) (>= (u2i u_n) 0)) (< (u2i u_n) 6)) (k_wellFormed u_heap))))
