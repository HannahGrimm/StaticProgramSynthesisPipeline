...
(assert (distinct sort_Field sort_Null sort_any sort_int sort_Heap sort_boolean sort_java.lang.Object))
...
; --- Sequent
(assert (not (=> (and (and (and (and (>= (u2i u_n) 0) (= u_n (i2u 1))) (>= (u2i u_n) 0)) (< (u2i u_n) 6)) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_n_old u_n)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  f = Helper.factorial(n);}\> (and(equals(f,Helper::factorial(heap,n)),equals(n,n_old)))
