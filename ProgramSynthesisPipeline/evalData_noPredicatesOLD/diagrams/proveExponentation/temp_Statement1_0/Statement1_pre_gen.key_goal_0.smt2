...
(assert (distinct sort_Field sort_Heap sort_any sort_java.lang.Object sort_boolean sort_int sort_Null))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (> (u2i u_n) 0) (> (u2i u_a) 0)) (< (u2i u_n) 6)) (< (u2i u_a) 6)) (>= (u2i u_i) 0)) (< (u2i u_i) (u2i u_n))) (k_wellFormed u_heap))))
