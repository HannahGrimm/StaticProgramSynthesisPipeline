...
(assert (distinct sort_Null |sort_int[]| sort_boolean sort_Heap sort_Field sort_any sort_java.lang.Object sort_int))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (forall ((var_q Int)) (=> (and (>= var_q 0) (< var_q (u2i u_wb))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) (i2u 0)))) (forall ((var_q Int)) (=> (and (>= var_q (u2i u_wb)) (< var_q (u2i u_wt))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) (i2u 1))))) (forall ((var_q Int)) (=> (and (>= var_q (u2i u_bb)) (< var_q (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) (i2u 2))))) (<= 0 (u2i u_wb))) (<= (u2i u_wb) (u2i u_wt))) (<= (u2i u_wt) (u2i u_bb))) (<= (u2i u_bb) (u2i (k_length u_A)))) (not (= u_wt u_bb))) (= (cast (k_select u_heap u_A (arr u_wt)) sort_int) (i2u 2))) (= u_variantVar0 (i2u (- (u2i u_bb) (u2i u_wt))))) (not (= u_A k_null))) (> (u2i (k_length u_A)) 0)) (<= 0 (u2i u_wb))) (<= (u2i u_wb) (u2i u_wt))) (<= (u2i u_wt) (u2i u_bb))) (<= (u2i u_bb) (u2i (k_length u_A)))) (forall ((var_i Int)) (=> (and (>= var_i 0) (< var_i (u2i (k_length u_A)))) (or (or (= (cast (k_select u_heap u_A (arr (i2u var_i))) sort_int) (i2u 0)) (= (cast (k_select u_heap u_A (arr (i2u var_i))) sort_int) (i2u 1))) (= (cast (k_select u_heap u_A (arr (i2u var_i))) sort_int) (i2u 2)))))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap))))
