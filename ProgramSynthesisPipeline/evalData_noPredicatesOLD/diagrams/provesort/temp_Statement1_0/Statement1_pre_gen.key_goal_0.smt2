...
(declare-fun u_data () U)
(declare-fun u_data1_oldVal () U)
...
(assert (distinct sort_boolean |sort_int[]| sort_any sort_Heap sort_java.lang.Object sort_Field sort_int sort_Null))
...
(assert (instanceof u_data |sort_int[]|))
(assert (instanceof u_data1_oldVal |sort_int[]|))
...
(assert (instanceof u_data_old |sort_int[]|))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (and (and (and (= u_data u_data1_oldVal) (not (= u_data k_null))) (>= (u2i u_i) 0)) (<= (u2i u_i) (u2i (k_length u_data)))) (<= (u2i u_j) (- (u2i (k_length u_data)) 2))) (>= (u2i u_j) (- (u2i u_i) 1))) (= (cast (k_select u_heap u_data |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (not (= u_data k_null))) (= (cast (k_select u_heap u_data_old |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap))))
