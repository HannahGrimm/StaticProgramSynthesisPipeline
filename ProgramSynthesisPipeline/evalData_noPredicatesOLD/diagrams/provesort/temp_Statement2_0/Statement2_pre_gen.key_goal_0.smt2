...
(assert (distinct sort_any sort_java.lang.Object |sort_int[]| sort_Field sort_int sort_Heap sort_boolean sort_Null))
...
; --- Sequent
(assert (not (and (and (and (and (and (and (and (and (forall ((var_k Int)) (=> (and (>= var_k 0) (< var_k (u2i u_i))) (forall ((var_m Int)) (=> (and (< var_k var_m) (< var_m (u2i (k_length u_A)))) (<= (u2i (cast (k_select u_heap u_A (arr (i2u var_k))) sort_int)) (u2i (cast (k_select u_heap u_A (arr (i2u var_m))) sort_int))))))) (not (= u_A k_null))) (>= (u2i u_i) 0)) (<= (u2i u_i) (u2i (k_length u_A)))) (< (u2i u_i) (u2i (k_length u_A)))) (<= (u2i u_j) (- (u2i (k_length u_A)) 2))) (>= (u2i u_j) (- (u2i u_i) 1))) (= (cast (k_select u_heap u_A |field_java.lang.Object::<created>|) sort_boolean) (b2u true))) (k_wellFormed u_heap))))
