...
(assert (distinct sort_int |sort_int[]| sort_Heap sort_boolean sort_Field sort_java.lang.Object))
...
; --- Sequent
(assert (not (and (forall ((var_k Int)) (=> (and (>= var_k 0) (< var_k (u2i u_i))) (forall ((var_m Int)) (=> (and (< var_k var_m) (< var_m (u2i (k_length u_A)))) (<= (u2i (cast (k_select u_heap u_A (arr (i2u var_k))) sort_int)) (u2i (cast (k_select u_heap u_A (arr (i2u var_m))) sort_int))))))) (= u_j (i2u (- (u2i (k_length u_A)) 2))))))
