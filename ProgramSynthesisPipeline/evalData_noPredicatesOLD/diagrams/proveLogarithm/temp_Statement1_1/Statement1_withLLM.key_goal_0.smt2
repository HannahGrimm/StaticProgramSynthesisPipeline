...
(assert (distinct sort_int sort_Field sort_java.lang.Object sort_any sort_Null sort_boolean sort_Heap))
...
(assert (instanceof u_N_old sort_int))
...
; --- Sequent
(assert (not (=> (and (and (and (and (and (and (and (> (u2i u_N) 0) (> (u2i u_N) 0)) (<= (u2i u_n) (u2i u_N))) (>= (u2i u_n) 1)) (>= (u2i u_l) 0)) (< (u2i u_l) (u2i u_N))) (< (u2i u_N) 20)) (k_wellFormed u_heap)) (u2b (let ((u_heapAtPre u_heap) (u_N_old u_N)) unknown_0)))))

(check-sat)

; --- Translation of unknown values
; unknown_0 :  \<{  l = 0;  n = N;}\> (and(and(geq(N,mul(n,Helper::pow(heap,Z(2(#)),l))),lt(N,mul(add(n,Z(1(#))),Helper::pow(heap,Z(2(#)),l)))),equals(N,N_old)))
