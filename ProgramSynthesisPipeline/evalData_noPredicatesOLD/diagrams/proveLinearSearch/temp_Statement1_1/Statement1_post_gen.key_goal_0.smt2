...
(assert (distinct sort_int sort_boolean sort_Field |sort_int[]| sort_java.lang.Object sort_Heap))
...
; --- Sequent
(assert (not (and (exists ((var_q Int)) (and (and (>= var_q 0) (< var_q (u2i (k_length u_A)))) (= (cast (k_select u_heap u_A (arr (i2u var_q))) sort_int) u_x))) (= u_i (i2u (- (u2i (k_length u_A)) 1))))))
